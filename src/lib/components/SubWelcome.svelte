<div class="h-[50vh] w-full flex flex-col justify-center items-center">
  ...
  <p class="mt-10 w-2/3 text-center font-serif text-lg">
    Step into a world of relaxation and transformation as you sink into our
    comfortable chairs, while we work our magic. Our commitment to excellence
    shines through every snip, every trim, and every shave.
  </p>
</div>
